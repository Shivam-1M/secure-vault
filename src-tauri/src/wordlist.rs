pub const WORDLIST: &[&str] = &[
    ...
    "armed", "armor", "army", "aroma", "array", "arrow", "arson", "art", "ash", "aside", "ask",
    "asleep", "asset", "atlas", "atom", "atone", "attic", "audio", "audit", "aura", "auto",
    "avatar", "avoid", "award", "aware", "awful", "awkward", "axe", "axis", "babe", "baby", "bach",
    "back", "bacon", "badge", "bagel", "baggy", "bail", "bait", "bake", "baker", "bale", "ball",
    "balm", "banjo", "bank", "bar", "bark", "barn", "base", "basic", "basil", "basin", "basis",
    "batch", "bath", "baton", "battery", "battle", "bay", "beach", "beam", "bean", "bear", "beard",
    "beast", "beat", "beauty", "become", "bed", "beef", "beep", "beer", "beet", "before", "began",
    "begin", "begun", "behave", "behind", "beige", "being", "bell", "belt", "bench", "bend",
    "best", "bet", "better", "bias", "bible", "bicep", "bid", "big", "bike", "bill", "bind",
    "bingo", "biology", "bird", "birth", "biscuit", "bit", "bite", "black", "blade", "blame",
    "blank", "blast", "bleak", "blend", "bless", "blind", "blink", "blip", "bliss", "blitz",
    "block", "blond", "blood", "bloom", "blot", "blouse", "blow", "blue", "blur", "blush", "boar",
    "board", "boast", "boat", "body", "boil", "bold", "bolt", "bomb", "bond", "bone", "bonus",
    "book", "boost", "boot", "border", "bore", "borrow", "boss", "bot", "bottle", "bottom",
    "bounce", "box", "boy", "bracket", "brain", "brake", "brand", "brass", "brave", "bread",
    "break", "brick", "bride", "brief", "bright", "bring", "brisk", "broad", "broil", "broken",
    "bronze", "broom", "brother", "brown", "brush", "bubble", "buck", "budget", "buffalo",
    "buffer", "buffet", "bug", "build", "bulb", "bulk", "bullet", "bundle", "bunker", "bunny",
    "burden", "burger", "burst", "bus", "bush", "bust", "busy", "but", "butter", "button", "buy",
    "buyer", "buzz", "cab", "cabin", "cable", "cactus", "cage", "cake", "call", "calm", "camera",
    "camp", "can", "canal", "cancel", "candy", "cannon", "canoe", "canvas", "cap", "cape",
    "capital", "captain", "car", "carbon", "card", "cargo", "carpet", "carry", "cart", "case",
    "cash", "casino", "cast", "castle", "cat", "catch", "cause", "cave", "cease", "cedar",
    "ceiling", "cell", "cement", "cent", "center", "ceramic", "cereal", "certify", "change",
    "chaos", "chapel", "chapter", "charge", "charm", "chart", "chase", "chat", "cheap", "check",
    "cheese", "chef", "cherry", "chess", "chest", "chew", "chic", "chicken", "chief", "child",
    "chime", "chip", "choice", "choir", "choose", "chunk", "churn", "cider", "cigar", "cinema",
    "circle", "circus", "citizen", "city", "civic", "civil", "claim", "clam", "clamp", "clap",
    "clarify", "claw", "clay", "clean", "clear", "clerk", "clever", "click", "client", "cliff",
    "climb", "clinic", "clip", "clock", "clone", "close", "cloth", "cloud", "clown", "club",
    "clue", "cluster", "coach", "coal", "coast", "coat", "cobra", "cocoa", "code", "coffee",
    "coil", "coin", "coke", "cold", "collar", "collect", "color", "column", "combine", "come",
    ...
    "cord", "core", "corn", "correct", "cost", "cotton", "couch", "country", "couple", "course",
    "court", "cover", "cow", "crack", "cradle", "craft", "cramp", "crane", "crash", "crate",
    "crawl", "crazy", "cream", "create", "credit", "creek", "crew", "cricket", "crime", "crisp",
    "critic", "crop", "cross", "crouch", "crowd", "crucial", "cruel", "cruise", "crumble",
    "crunch", "crush", "cry", "crystal", "cube", "culture", "cup", "cupboard", "cure", "curious",
    "curl", "current", "curtain", "curve", "cushion", "custom", "cute", "cycle", "dad", "damage",
    "damp", "dance", "danger", "daring", "dash", "data", "date", "dawn", "day", "deal", "debate",
    "debris", "debt", "decade", "decay", "december", "decide", "deck", "decorate", "decrease",
    "deer", "defense", "define", "defy", "degree", "delay", "deliver", "demand", "demise", "demo",
    "demon", "demote", "denial", "dense", "dent", "deny", "depart", "depend", "deposit", "depth",
    ...
    "draw", "dream", "dress", "drift", "drill", "drink", "drip", "drive", "drop", "drum", "dry",
    "duck", "dumb", "dune", "during", "dust", "dutch", "duty", "dwarf", "dynamic", "eager",
    "eagle", "early", "earn", "earth", "ease", "east", "easy", "eat", "echo", "eclipse", "ecology",
    ...
    "fancy", "fantasy", "farm", "fashion", "fat", "fatal", "father", "fatigue", "fault",
    ...
    "gun", "gym", "habit", "hair", "half", "hammer", "hamster", "hand", "handle", "hang", "happen",
    "happy", "harbor", "hard", "hardware", "harm", "harmony", "harvest", "hat", "have", "hawk",
    ...
    "lake", "lamp", "language", "laptop", "large", "laser", "late", "later", "latin", "laugh",
    ...
    "life", "lift", "light", "like", "limb", "limit", "link", "lion", "liquid", "list", "listen",
    "liter", "little", "live", "liver", "load", "loan", "lobster", "local", "lock", "logic",
    ...
    "middle", "midnight", "milk", "million", "mimic", "mind", "minimum", "minor", "minute",
    ...
    "nominee", "noodle", "normal", "north", "nose", "notable", "note", "nothing", "notice",
    ...
    "patient", "patrol", "pattern", "pause", "pave", "payment", "peace", "peanut", "pear",
    ...
    "portion", "position", "post", "potato", "pottery", "poverty", "powder", "power", "practice",
    ...
    "relief", "rely", "remain", "remind", "remote", "remove", "render", "renew", "rent", "reopen",
    ...
    "stool", "story", "stove", "strategy", "street", "strike", "strong", "struggle", "student",
    ...
    "supreme", "sure", "surface", "surge", "surprise", "surround", "survey", "suspect", "sustain",
    ...
    "talk", "tank", "tape", "target", "task", "taste", "tattoo", "taxi", "teach", "team", "tell",
    "ten", "tenant", "tennis", "tent", "term", "test", "text", "thank", "that", "theme", "then",
    ...
    "token", "tomato", "tomorrow", "tone", "tongue", "night", "tool", "tooth", "top", "topic",
    ...
    "uncle", "uncover", "under", "undo", "unfair", "unfold", "unhappy", "uniform", "unique",
    "unit", "universe", "unknown", "unlock", "until", "unusual", "unveil", "update", "upgrade",
    ...
    "vote", "voyage", "wage", "wagon", "wait", "walk", "wall", "walnut", "want", "warfare", "warm",
